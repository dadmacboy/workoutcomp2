window.GYM_DATA = {
  equipment: [
    { id: "bodyweight", name: "Bodyweight", note: "Floor, bench, or pull-up bar" },
    { id: "trx", name: "TRX", note: "Suspension trainer" },
    { id: "cable", name: "Cable / rope", note: "Cable station and attachments" },
    { id: "dumbbell", name: "Dumbbells", note: "One or two dumbbells" },
    { id: "machine", name: "Machines", note: "Selectorized or plate-loaded" },
    { id: "smith", name: "Smith machine", note: "Guided barbell station" }
  ],
